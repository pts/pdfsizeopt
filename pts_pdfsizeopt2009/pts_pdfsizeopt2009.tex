...
libraries and archives \cite{multivalent-articles}.
...
a more compact document representation or more agressive compression than
...
This subsection describes some methods PDF optimizers use the reduce the file
...
% !! write more about the comparison in multivalent-compress-tool
...
cruft between object definitions is removed;
...
\cite{pdf-contatenate}) to concatenate PDF files if necessary. Pay attention
...
compact PDF stores Type\,1 fonts unencrypted, with cruft such as the
...
!! add more conclusions and future work
