...
pdf\TeX{}: \texttt{pdflatex "\pdfmapfile{pdftex\_ndl14.map}\input" doc.tex}.
However, this will display a warning \emph{No flags specified for
non-embedded font}. To get rid of this, use
\texttt{pdflatex "\pdfmapfile{=pdftex\_ndl14_extraflag.map}\input" doc.tex}
...
% !! pdflatex "\pdfmapfile{=pdftex_ndl14.map}\input" thello
