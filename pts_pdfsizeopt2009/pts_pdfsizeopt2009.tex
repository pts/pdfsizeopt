...
!! 
-rw-r--r-- 1 pts eng 2283510 Jul 22 14:42 texbook.pdf
-rw-r--r-- 1 pts eng 2269821 Jul 21 14:38 texbook_dvipdfm.pdf
-rw-r--r-- 1 pts eng 2007012 Jul 21 15:06 texbook_dvipdfmx.pdf
-rw-r--r-- 1 pts eng 3485081 Jul 22 14:41 texbook_dvips.pdf
...
\LaTeX{}-package accepts a PDF as the image file. With \cmd{dvipdfm(x)},
one also needs a \texttt{.bb} file containing the bounding box. This can be
generated with the \cmd{ebb} command, shipping with \cmd{dvipdfm(x)}. Or, it
is possible to use the \pkg{pts-graphics-helper} package
\cite{pts-graphics-helper}.
 ...
 (For \cmd{p
We recommend typesetting new graphics with TikZ \cite{tikz} if possible
...
parts of them to the document.  In this case, the first page of the specified PDF will be used as a
