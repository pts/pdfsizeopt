...
\toprule
% TODO: why is Multivalent alone better on pdf_reference_1-7? what about extra
%       compression
...
@creative-pdf{
  ...
  !! make URL appear
  % !! url={http://www.tu-chemnitz.de/urz/anwendungen/tex/stammtisch/chronik/pdf_interna.pdf},
}
...
@pdfenhancer-features{
  % http://www.apagoinc.com/prod_feat.php?feat_id=30&feat_disp_order=7&prod_id=2
}

!!
@pdf-diet{
% "Two Diet Plans for Fat PDF", Proceedings of ACM Symposium on Document Engineering 2003, November 2003, Grenoble, France. 
% http://portal.acm.org/citation.cfm?doid=958220.958253
